...
-- insert into book (id, title, isbn, author, description, year)values('7', 'Ludzie ze złota', '45234523', 'Jakub Radomski, Edyta Kowalczyk', 'Złoto - można powiedzieć, że to słowo-klucz tej książki. A jego blask mieni się w każdej historii. ', '2019');
--
-- insert into book (id, title, isbn, author, description, year)values ('8', 'Rana', '54325342', 'Wojciech Chmielarz', 'Podobno czas leczy rany. Jednak niektóre nigdy się nie zabliźniają.', '2019');
--
